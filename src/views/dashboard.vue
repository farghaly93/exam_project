...
<v-navigation-drawer
  ...
  <v-footer app fixed color="#566673de">
    <div style="margin-left:auto;margin-right:auto" class="text-center">
      <v-btn class="mx-2" fab dark color="#4267b2">
        <v-icon dark>mdi-facebook</v-icon>
      </v-btn>
  
      <v-btn class="mx-2" fab dark color="pink">
        <v-icon dark>mdi-youtube-play</v-icon>
      </v-btn>
    ...
    <div class="col-md-12">
      <h5 style="text-align:center;color:#fff">Farghaly developes</h5>
    </div>
  </v-footer>
...
export default {
  data() {
    return {
      ...
      item: true,
      items: [
        { title: 'Dashboard', icon: 'mdi-chart-areaspline' , link: '/dashboard'},
        { title: 'Users', icon: 'mdi-account', link: '/dashboard/users' },
        { title: 'Add exam', icon: 'mdi-format-align-justify', link: "/dashboard/redirector/*dashboard*addExam" },
